...
const FileItem = ({ name, type, term, selected, onSelect, alwaysShowCheckbox }: FileItemProps) => {
    ...
    return (
        <div className="flex items-center gap-3 rounded-md bg-muted p-2 w-full group">
